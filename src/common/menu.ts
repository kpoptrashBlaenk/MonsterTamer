...
import {MENU_COLOR} from "../battle/menu/menu-config";
...
export class Menu {
    ...
    private getMenuColorsFromDataManager(): { main: number, border: number } | undefined {
        const chosenMenuColor: MenuColorOptions = dataManager.getStore.get(DATA_MANAGER_STORE_KEYS.OPTIONS_MENU_COLOR)
