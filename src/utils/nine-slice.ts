...
export class NineSlice {
    ...
    private createNineSliceTextures(textureManager: Phaser.Textures.TextureManager, assetKey: UIAssetKeys): void {
    ...
    public createNineSliceContainer(scene: Phaser.Scene, targetWidth: number, targetHeight: number, assetKey: UIAssetKeys): Phaser.GameObjects.Container {
    ...
    public updateNineSliceContainerTexture(textureManager: Phaser.Textures.TextureManager, container: Phaser.GameObjects.Container, assetKey: UIAssetKeys): void {
