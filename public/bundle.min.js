(() => {
  ...
  var Controls = class {
    ...
    constructor(scene) {
      ...
      this.escapeKey = this.scene.input.keyboard?.addKey(phaser_default.Input.Keyboard.KeyCodes.ESC);
    ...
    wasEscapeKeyPressed() {
      if (this.escapeKey === void 0) {
        return false;
      }
      return phaser_default.Input.Keyboard.JustDown(this.escapeKey);
    }
    wasSpaceKeyPressed() {
  ...
  // src/battle/menu/menu-config.ts
  var MENU_COLOR = Object.freeze({
    1: {
      main: 3294540,
      border: 7183016
    },
  ...
  // src/battle/menu/menu.ts
  var MENU_OPTIONS = Object.freeze({
  ...
  var MENU_TEXT_STYLE2 = Object.freeze({
    fontFamily: CUSTOM_FONTS.POKEROGUE,
    color: "#FFFFFF",
    fontSize: "35px"
  });
  var Menu = class {
    ...
    constructor(scene) {
      ...
      for (let i = 0; i < this.availableMenuOptions.length; i++) {
        ...
        const textObj = this.scene.add.text(40 + this.padding, y, this.availableMenuOptions[i], MENU_TEXT_STYLE2);
